#!/usr/bin/env python3
"""Generate all remaining engine module files for the Genovo engine."""
import os
...
# ============================================================================
# 1. physics/src/physics_debug_v2.rs
# ============================================================================
total += write_file("physics/src/physics_debug_v2.rs", r'''// engine/physics/src/physics_debug_v2.rs
//
