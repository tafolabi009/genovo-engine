//! Classic 8x16 VGA/BIOS bitmap font data (public domain).
//!
//! Each character is represented as 16 bytes, where each byte is one row of
//! 8 pixels (MSB = leftmost pixel). Covers ASCII 32..=126 (95 characters).

/// Returns the 16-byte bitmap for a given ASCII character.
...
/// Classic 8x16 VGA font data. 95 glyphs for ASCII 32..=126.
/// This is the public-domain IBM VGA 8x16 font (Code Page 437 subset).
